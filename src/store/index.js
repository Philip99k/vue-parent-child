...
export default createStore({
    state: {
        ...
        children: {
            byId: {
                11: { id: 11, firstName: "Anna", lastName: "Arm", birthdate: "2005-02-01", parent: 111 },
                22: { id: 22, firstName: "Alf", lastName: "Alla", birthdate: "2010-02-02", parent: 111 },
                33: { id: 33, firstName: "Berta", lastName: "Bein", birthdate: "2015-02-03", parent: 222 },
                44: { id: 44, firstName: "Ben", lastName: "Bauch", birthdate: "2020-02-04", parent: 222 }
            },
            allIds: [11, 22, 33, 44]
        }
    },
    getters: {
        ...
        sumOfChildAge: state => {
            ...
            for (let index = 0; index < state.children.allIds.length; index++) {
                const child = state.children.allIds[index];

                const today = new Date();
                let birthdate = new Date(state.children.byId[child].birthdate);
